...
import { CostSimulationList } from "./costSimulation/CostSimulationList";
import { CostSimulationCreate } from "./costSimulation/CostSimulationCreate";
import { CostSimulationEdit } from "./costSimulation/CostSimulationEdit";
import { CostSimulationShow } from "./costSimulation/CostSimulationShow";
...
import { GpsDatumList } from "./gpsDatum/GpsDatumList";
import { GpsDatumCreate } from "./gpsDatum/GpsDatumCreate";
import { GpsDatumEdit } from "./gpsDatum/GpsDatumEdit";
import { GpsDatumShow } from "./gpsDatum/GpsDatumShow";
...
import { BudgetItemList } from "./budgetItem/BudgetItemList";
import { BudgetItemCreate } from "./budgetItem/BudgetItemCreate";
import { BudgetItemEdit } from "./budgetItem/BudgetItemEdit";
import { BudgetItemShow } from "./budgetItem/BudgetItemShow";
  ...
  return (
    <div className="App">
      ...
      >
        ...
        <Resource
          name="CostSimulation"
          list={CostSimulationList}
          edit={CostSimulationEdit}
          create={CostSimulationCreate}
          show={CostSimulationShow}
        />
        <Resource
          name="Route"
          list={RouteList}
