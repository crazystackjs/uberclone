...
const CREATE_INPUT = {
  ...
  customerPhone: "exampleCustomerPhone",
  customerWhatsapp: "exampleCustomerWhatsapp",
  destinationLocationType: "exampleDestinationLocationType",
  exclusiveTruck: "true",
  flexibleDate: "true",
  hoisting: "true",
  id: "exampleId",
  insurance: "true",
  originLocationType: "exampleOriginLocationType",
