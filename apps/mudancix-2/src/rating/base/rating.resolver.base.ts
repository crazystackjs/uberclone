...
export class RatingResolverBase {
  ...
  async createRating(@graphql.Args() args: CreateRatingArgs): Promise<Rating> {
    return await this.service.createRating({
      ...
      data: {
        ...
        ratee: {
          connect: args.data.ratee,
        },

        rater: {
          connect: args.data.rater,
        },
      },
    });
  }
  ...
  async getRatee(@graphql.Parent() parent: Rating): Promise<User | null> {
    const result = await this.service.getRatee(parent.id);
  ...
  async getRater(@graphql.Parent() parent: Rating): Promise<User | null> {
    const result = await this.service.getRater(parent.id);
