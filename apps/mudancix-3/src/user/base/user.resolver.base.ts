...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [Rating], { name: "ratingsGiven" })
  async findRatingsGiven(
    @graphql.Parent() parent: User,
    @graphql.Args() args: RatingFindManyArgs
  ): Promise<Rating[]> {
    const results = await this.service.findRatingsGiven(parent.id, args);
  ...
  @graphql.ResolveField(() => [Rating], { name: "ratingsReceived" })
  ...
  @graphql.ResolveField(() => [SupportTicket], { name: "supportTicket" })
  async findSupportTicket(
    @graphql.Parent() parent: User,
    @graphql.Args() args: SupportTicketFindManyArgs
  ): Promise<SupportTicket[]> {
    const results = await this.service.findSupportTicket(parent.id, args);
