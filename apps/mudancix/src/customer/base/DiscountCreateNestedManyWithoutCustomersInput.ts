...
@InputType()
class DiscountCreateNestedManyWithoutCustomersInput {
...
export { DiscountCreateNestedManyWithoutCustomersInput as DiscountCreateNestedManyWithoutCustomersInput };
