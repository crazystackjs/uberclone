...
export class ChatRoomServiceBase {
  ...
  async ChatRoomConnectMessages(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async ChatRoomDisconnectMessages(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async ChatRoomFindMessages(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async ChatRoomUpdateMessages(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
}
