...
class RiderCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => RideRequestCreateNestedManyWithoutRidersInput,
  })
  @ValidateNested()
  @Type(() => RideRequestCreateNestedManyWithoutRidersInput)
  @IsOptional()
  @Field(() => RideRequestCreateNestedManyWithoutRidersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => RideCreateNestedManyWithoutRidersInput,
  })
  @ValidateNested()
  @Type(() => RideCreateNestedManyWithoutRidersInput)
  @IsOptional()
  @Field(() => RideCreateNestedManyWithoutRidersInput, {
    nullable: true,
  })
  rides?: RideCreateNestedManyWithoutRidersInput;
}

export { RiderCreateInput as RiderCreateInput };
